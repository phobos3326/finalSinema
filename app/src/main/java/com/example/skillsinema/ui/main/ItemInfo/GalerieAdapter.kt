...
class GalerieAdapter @Inject constructor() : PagingDataAdapter<ModelGalerie.Item, RecyclerView.ViewHolder>(DiffUtilCallback()) {


    class DiffUtilCallback : DiffUtil.ItemCallback<ModelGalerie.Item>() {
        override fun areItemsTheSame(oldItem: ModelGalerie.Item, newItem: ModelGalerie.Item): Boolean = oldItem == newItem

        override fun areContentsTheSame(oldItem: ModelGalerie.Item, newItem: ModelGalerie.Item): Boolean = oldItem == newItem
    }
