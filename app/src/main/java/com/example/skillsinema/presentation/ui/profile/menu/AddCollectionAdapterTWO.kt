...
class AddCollectionAdapterTWO @Inject constructor(
    ...
    class DiffUtilCallback : DiffUtil.ItemCallback<CollectionsUiModel>() {
        override fun areItemsTheSame(oldItem: CollectionsUiModel, newItem: CollectionsUiModel): Boolean {
            return oldItem == newItem
        }

        override fun areContentsTheSame(oldItem: CollectionsUiModel, newItem: CollectionsUiModel): Boolean {
            return oldItem == newItem
        }
    }
