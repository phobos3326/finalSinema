package com.example.skillsinema.presentation.ui.actorInfo
...
import com.example.skillsinema.presentation.ui.adapters.AdapterFilteredFilms
...
class ActorInfoFragment @Inject constructor() : Fragment() {
    ...
    private val adapter = AdapterFilteredFilms(
    ...
    private fun onItemDetailClick(item: Film, type: TypeItem) {
        val filmId = item.kinopoiskId ?: return
        bundle.putInt("Arg", filmId)
        viewModel.isertItemToDb(type, filmId)
